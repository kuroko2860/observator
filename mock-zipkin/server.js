  ...
  const traceData = [
    {
      ...
      id: "span-1",
      parentId: null,
      name: "service-1-entry",
      localEndpoint: "service-1",
      timestamp: timestamp + getRandomInt(1000, 5000),
    ...
    },
    {
      ...
      id: "span-2",
      parentId: "span-1",
      name: "service-2-handler",
      localEndpoint: "service-2",
      timestamp: timestamp + getRandomInt(1000, 5000),
      duration: getRandomInt(10000, 200000),
      tags: {
        "http.method": "POST",
    ...
    },
    {
      ...
      id: "span-3",
      parentId: "span-2",
      name: "service-3-validate",
      localEndpoint: "service-3",
      timestamp: timestamp + getRandomInt(1000, 5000),
      duration: getRandomInt(10000, 200000),
      tags: {
        validation: "passed",
    ...
    },
    {
      ...
      id: "span-4",
      parentId: "span-3",
      name: "service-4-query",
      localEndpoint: "service-4",
      timestamp: timestamp + getRandomInt(1000, 5000),
      duration: getRandomInt(10000, 200000),
      tags: {
    ...
    },
    {
      ...
      id: "span-6",
      parentId: "span-2",
      name: "service-5-logging",
      localEndpoint: "service-5",
      timestamp: timestamp + getRandomInt(1000, 5000),
      duration: getRandomInt(10000, 200000),
      tags: {
        "log.level": "INFO",
