...
const (
	...
	InventoryService_VerifyInventory_FullMethodName = "/inventory.InventoryService/VerifyInventory"
)
...
type InventoryServiceClient interface {
	...
	VerifyInventory(ctx context.Context, in *VerifyInventoryRequest, opts ...grpc.CallOption) (*VerifyInventoryResponse, error)
}
...
func (c *inventoryServiceClient) VerifyInventory(ctx context.Context, in *VerifyInventoryRequest, opts ...grpc.CallOption) (*VerifyInventoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VerifyInventoryResponse)
	err := c.cc.Invoke(ctx, InventoryService_VerifyInventory_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InventoryServiceServer interface {
	...
	VerifyInventory(context.Context, *VerifyInventoryRequest) (*VerifyInventoryResponse, error)
...
func (UnimplementedInventoryServiceServer) VerifyInventory(context.Context, *VerifyInventoryRequest) (*VerifyInventoryResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method VerifyInventory not implemented")
}
...
func _InventoryService_VerifyInventory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VerifyInventoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InventoryServiceServer).VerifyInventory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InventoryService_VerifyInventory_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InventoryServiceServer).VerifyInventory(ctx, req.(*VerifyInventoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InventoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VerifyInventory",
			Handler:    _InventoryService_VerifyInventory_Handler,
		},
	},
